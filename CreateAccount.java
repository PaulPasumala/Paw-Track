...
public class CreateAccount extends JFrame {
    ...
    private static class RoundedPasswordField extends JPasswordField {
        ...
        public RoundedPasswordField(int columns) {
            ...
            // --- REMOVED UppercaseDocumentFilter ---
    ...
    public CreateAccount() {
        ...
        // --- ADDED FOR "ENTER" KEY ---
        // This must be after submitButton is initialized in createInfoContent()
    ...
    private JLabel createImageLabel(String resourcePath, int width, int height) {
        ...
        try {
            ...
            InputStream resourceStream = new java.io.FileInputStream(resourcePath);
