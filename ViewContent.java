...
public class ViewContent extends JFrame {
    ...
    private ImageIcon loadPetImage(String petName) {
        try {
            ...
            // Simplified directories search for standard resource loading
            String[] directories = {
                    "/images/pets/", // Preferred resource path
                    "/" // Root fallback
            };

            // Cleaned pet name for path
            String cleanedPetName = petName.toLowerCase().replaceAll("\\s+", "_");

            for (String dir : directories) {
                for (String ext : extensions) {
                    String imagePath = dir + cleanedPetName + ext;
