...
public class Donation extends JFrame {
    ...
    // --- CONFIGURATION ---
    // 1. Main Header Image
    private static final String DEFAULT_IMAGE_PATH = "resources/image/DONATION.1.png"; 
    
    // 2. QR Code Images (Put your file paths here)
    private static final String GCASH_QR_PATH = "resources/image/GCASH.png";      
    private static final String MAYA_QR_PATH = "resources/image/MAYA.png";       
    // --- THEME COLORS ---
    // NEW GRADIENT: "Neon Twilight" (Deep Violet to Hot Pink)
    private static final Color GRADIENT_START = new Color(41, 128, 185);   // Blue
    private static final Color GRADIENT_END = new Color(231, 76, 60);      // Pink/Coral
    ...
    private String[] slideshowImagePaths = new String[] {
        DEFAULT_IMAGE_PATH,
        "resources/image/DONATION.2.png",
        "resources/image/DONATION.3.png",
        "resources/image/DONATION.4.png"
    };
    private int currentImageIndex = 0;
    private javax.swing.Timer slideshowTimer;
    
    private boolean imagesLoaded = false; // Track if images have been loaded
    ...
    public Donation() {
        ...
        // Load images immediately for standalone window
        loadImagesIfNeeded();
    }
    ...
    public JPanel createDonationPanel() {
        ...
        // Add component listener to load images only when panel becomes visible
        bgPanel.addComponentListener(new java.awt.event.ComponentAdapter() {
            @Override
        ...
        // DO NOT load images here - wait until panel is shown
        // loadDefaultImage();
        // startSlideshow();
    ...
    // Helper method to load images only once
    ...
    private JPanel createHeaderSection() {
        ...
        JLabel title = new JLabel("PAWS FOR A CAUSE");
    ...
    private void startSlideshow() {
        ...
        slideshowTimer = new javax.swing.Timer(20000, e -> {
            currentImageIndex = (currentImageIndex + 1) % slideshowImagePaths.length;
            showImageAtIndex(currentImageIndex);
        });
        slideshowTimer.setInitialDelay(20000);
        slideshowTimer.start();
    }

    // Add method to stop slideshow when panel is hidden (optional optimization)
