...
public class AboutUs {
    ...
    // Blue-pink gradient for background (matching Paw Management)
    private static final Color GRADIENT_START = new Color(99, 102, 241);   // Blue
    private static final Color GRADIENT_END = new Color(236, 72, 153);     // Pink
    ...
    public static JPanel createAboutUsPanel() {
        ...
        footerPanel.add(createSocialLink("facebook", " ", ""));
        footerPanel.add(createSocialLink("instagram", " ", ""));
        footerPanel.add(createSocialLink("linkedin", " ", ""));
