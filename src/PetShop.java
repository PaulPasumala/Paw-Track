...
public class PetShop extends JFrame {
    ...
    public static class UITheme {
        ...
        // Gradient Colors for Blue-Pink Theme
        public static final Color GRADIENT_BLUE_START = new Color(66, 153, 225);
        public static final Color GRADIENT_PINK_END = new Color(237, 100, 166);
    ...
    public class NavigationBar extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            GradientPaint gradient = new GradientPaint(0, 0, UITheme.GRADIENT_BLUE_START, getWidth(), 0, UITheme.GRADIENT_PINK_END);
    ...
    private void showCartDialog() {
        ...
        JPanel mainPanel = new JPanel(new BorderLayout()) {
            ...
            protected void paintComponent(Graphics g) {
                super.paintComponent(g);
                Graphics2D g2d = (Graphics2D) g;
                GradientPaint gradient = new GradientPaint(0, 0, UITheme.GRADIENT_BLUE_START, 0, getHeight(), UITheme.GRADIENT_PINK_END);
                g2d.setPaint(gradient);
                g2d.fillRect(0, 0, getWidth(), getHeight());
            }
        };
    ...
    private void showProductDetailModal(Item item) {
        ...
        JPanel mainContainer = new JPanel(new BorderLayout()) {
            ...
            protected void paintComponent(Graphics g) {
                ...
                // Blue-pink gradient with dark overlay
                GradientPaint gradient = new GradientPaint(0, 0, new Color(66, 153, 225, 180), 
                    0, getHeight(), new Color(237, 100, 166, 120));
                g2d.setPaint(gradient);
                g2d.fillRect(0, 0, getWidth(), getHeight());
