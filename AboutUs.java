...
public class AboutUs {
    ...
    public static void main(String[] args) {
        // This main method is now clean. The app is launched from Dashboard.
    ...
    public static JPanel createAboutUsPanel() {
        ...
        // --- Image File Paths for each person (Using resource paths) ---
        ...
        String dayritImagePath = "/PERSON/DAYRIT ENHANCE.jpg";
...
class PersonPanel extends JPanel {
    ...
    public PersonPanel(String name, String description, String imagePath, boolean reverse) {
        ...
        try {
            // CORRECT RESOURCE LOADING: Reads image from inside the bundled JAR.
